                ...
                <tbody>       
                  ...
                  ?>      
                    <tr>
                        ...
                        <td><a href="qldv-update.php?madv=<?php echo $row['madv'];?>"><i class="bi bi-pencil-square"></i></a></td>
                        <td><a href="qldv-delete.php?madv=<?php echo $row['madv'];?>"><i class="bi bi-trash"></i></i></a></td>
